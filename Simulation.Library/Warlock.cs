...
namespace Simulation.Library
{
    public class Warlock : PlayerClass
    {
        ...
        {
            new(){ ID = "17788", Level = 1, Name = baneStr, Effects = new Effect[] { new(){ AffectedSpells = baneAffectedSpells1, Modify = Modify.Casttime, Value = -100 }, new(){AffectedSpells = baneAffectedSpells2, Modify = Modify.Casttime, Value = -400 } } },
            new(){ ID = "17789", Level = 2, Name = baneStr, Effects = new Effect[] { new(){ AffectedSpells = baneAffectedSpells1, Modify = Modify.Casttime, Value = -200 }, new(){AffectedSpells = baneAffectedSpells2, Modify = Modify.Casttime, Value = -800 } } },
            new(){ ID = "17790", Level = 3, Name = baneStr, Effects = new Effect[] { new(){ AffectedSpells = baneAffectedSpells1, Modify = Modify.Casttime, Value = -300 }, new(){AffectedSpells = baneAffectedSpells2, Modify = Modify.Casttime, Value = -1200 } } },
            new(){ ID = "17791", Level = 4, Name = baneStr, Effects = new Effect[] { new(){ AffectedSpells = baneAffectedSpells1, Modify = Modify.Casttime, Value = -400 }, new(){AffectedSpells = baneAffectedSpells2, Modify = Modify.Casttime, Value = -1600 } } },
            new(){ ID = "17792", Level = 5, Name = baneStr, Effects = new Effect[] { new(){ AffectedSpells = baneAffectedSpells1, Modify = Modify.Casttime, Value = -500 }, new(){AffectedSpells = baneAffectedSpells2, Modify = Modify.Casttime, Value = -2000 } } }
        };
        ...
        {
            new(){ ID = "17778", Level = 1, Name = cataclysmStr, Effects = new Effect[] { new(){ AffectedSpells = cataclysmAffectedSpells , Modify = Modify.ManaPercent, Value = -1 } } },
            new(){ ID = "17779", Level = 2, Name = cataclysmStr, Effects = new Effect[] { new(){ AffectedSpells = cataclysmAffectedSpells, Modify = Modify.ManaPercent, Value = -2 } } },
            new(){ ID = "17780", Level = 3, Name = cataclysmStr, Effects = new Effect[] { new(){ AffectedSpells = cataclysmAffectedSpells, Modify = Modify.ManaPercent, Value = -3 } } },
            new(){ ID = "17781", Level = 4, Name = cataclysmStr, Effects = new Effect[] { new(){ AffectedSpells = cataclysmAffectedSpells, Modify = Modify.ManaPercent, Value = -4 } } },
            new(){ ID = "17782", Level = 5, Name = cataclysmStr, Effects = new Effect[] { new(){ AffectedSpells = cataclysmAffectedSpells, Modify = Modify.ManaPercent, Value = -5 } } }
        };
        ...
        {
            new(){ ID = "17793", Level = 1, Name = improvedShadowBoltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedShadowBoltAffectedSpells, Modify = Modify.ManaPercent, Value = 4 } } },
            new(){ ID = "17796", Level = 2, Name = improvedShadowBoltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedShadowBoltAffectedSpells, Modify = Modify.ManaPercent, Value = 8 } } },
            new(){ ID = "17801", Level = 3, Name = improvedShadowBoltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedShadowBoltAffectedSpells, Modify = Modify.ManaPercent, Value = 12 } } },
            new(){ ID = "17802", Level = 4, Name = improvedShadowBoltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedShadowBoltAffectedSpells, Modify = Modify.ManaPercent, Value = 16 } } },
            new(){ ID = "17803", Level = 5, Name = improvedShadowBoltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedShadowBoltAffectedSpells, Modify = Modify.ManaPercent, Value = 20 } } },
        };
        ...
        {
            new(){ ID = "18126", Level = 1, Name = improvedFireboltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedFireboltAffectSpells, Modify = Modify.Casttime, Value = -250 } } },
            new(){ ID = "18127", Level = 2, Name = improvedFireboltStr, Effects = new Effect[] { new(){ AffectedSpells = improvedFireboltAffectSpells, Modify = Modify.Casttime, Value = -500 } } }
        };
        ...
        {
            new(){ ID = "18128", Level = 1, Name = improvedLashOfPainStr, Effects = new Effect[] { new(){ AffectedSpells = improvedLashOfPainAffectedSpells, Modify = Modify.Cooldown, Value = -3000 } } },
            new(){ ID = "18129", Level = 2, Name = improvedLashOfPainStr, Effects = new Effect[] { new(){ AffectedSpells = improvedLashOfPainAffectedSpells, Modify = Modify.Cooldown, Value = -6000 } } }
        };
        ...
        {
            new(){ ID = "18130", Level = 1, Name = devastationStr, Effects = new Effect[] { new(){ AffectedSpells = devastationAffectedSpells, Modify = Modify.SpellCritChance, Value = 1 } } },
            new(){ ID = "18131", Level = 2, Name = devastationStr, Effects = new Effect[] { new(){ AffectedSpells = devastationAffectedSpells, Modify = Modify.SpellCritChance, Value = 2 } } },
            new(){ ID = "18132", Level = 3, Name = devastationStr, Effects = new Effect[] { new(){ AffectedSpells = devastationAffectedSpells, Modify = Modify.SpellCritChance, Value = 3 } } },
            new(){ ID = "18133", Level = 4, Name = devastationStr, Effects = new Effect[] { new(){ AffectedSpells = devastationAffectedSpells, Modify = Modify.SpellCritChance, Value = 4 } } },
            new(){ ID = "18134", Level = 5, Name = devastationStr, Effects = new Effect[] { new(){ AffectedSpells = devastationAffectedSpells, Modify = Modify.SpellCritChance, Value = 5 } } }
        };

        private static string[] shadowburnAffectedSpells = new[] { shadowburnStr };
        private Talent shadowburn = new() { ID = "17877", Level = 1, Name = shadowburnStr, Effects = new Effect[] { new() { AffectedSpells = shadowburnAffectedSpells, Modify = Modify.LearnSpell, Value = 17962 } } };
        ...
        {
            new() { ID = "17927", Level = 1, Name = improvedSearingPainStr, Effects = new Effect[] { new() { AffectedSpells = improvedSearingPainAffectedSpells, Modify = Modify.SpellCritChance, Value = 4 } } },
            new() { ID = "17929", Level = 2, Name = improvedSearingPainStr, Effects = new Effect[] { new() { AffectedSpells = improvedSearingPainAffectedSpells, Modify = Modify.SpellCritChance, Value = 7 } } },
            new() { ID = "17930", Level = 3, Name = improvedSearingPainStr, Effects = new Effect[] { new() { AffectedSpells = improvedSearingPainAffectedSpells, Modify = Modify.SpellCritChance, Value = 10 } } }
        };
        ...
        {
            new() { ID = "17815", Level = 1, Name = improvedImmolateStr, Effects = new Effect[] { new() { AffectedSpells = improvedImmolateAffectedSpells, Modify = Modify.DamagePercent, Value = 5 } } },
            new() { ID = "17833", Level = 2, Name = improvedImmolateStr, Effects = new Effect[] { new() { AffectedSpells = improvedImmolateAffectedSpells, Modify = Modify.DamagePercent, Value = 10 } } },
            new() { ID = "17834", Level = 3, Name = improvedImmolateStr, Effects = new Effect[] { new() { AffectedSpells = improvedImmolateAffectedSpells, Modify = Modify.DamagePercent, Value = 15 } } },
            new() { ID = "17835", Level = 4, Name = improvedImmolateStr, Effects = new Effect[] { new() { AffectedSpells = improvedImmolateAffectedSpells, Modify = Modify.DamagePercent, Value = 20 } } },
            new() { ID = "17836", Level = 5, Name = improvedImmolateStr, Effects = new Effect[] { new() { AffectedSpells = improvedImmolateAffectedSpells, Modify = Modify.DamagePercent, Value = 25 } } }
        };

        private static string[] ruinAffectedSpells => destructionSpells;
        private const string ruinStr = "Ruin";
        private Talent ruin = new() { ID = "17959", Level = 1, Name = ruinStr, Effects = new Effect[] { new() { AffectedSpells = ruinAffectedSpells, Modify = Modify.CritDamagePercent, Value = 100 } } };
        ...
        {
        new() { ID = "17954", Level = 1, Name = emberstormStr, Effects = new Effect[] { new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.DamagePercent, Value = 2 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 2 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.CasttimePercent, Value = -2 } } },
        new() { ID = "17955", Level = 2, Name = emberstormStr, Effects = new Effect[] { new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.DamagePercent, Value = 4 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 4 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.CasttimePercent, Value = -4 } } },
        new() { ID = "17956", Level = 3, Name = emberstormStr, Effects = new Effect[] { new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.DamagePercent, Value = 6 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 6 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.CasttimePercent, Value = -6 } } },
        new() { ID = "17957", Level = 4, Name = emberstormStr, Effects = new Effect[] { new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.DamagePercent, Value = 8 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 8 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.CasttimePercent, Value = -8 } } },
        new() { ID = "17958", Level = 5, Name = emberstormStr, Effects = new Effect[] { new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.DamagePercent, Value = 10 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 10 }, new() { AffectedSpells = emberstormAffectedSpells, Modify = Modify.CasttimePercent, Value = -10 } } },
        };

        private static string[] conflagrateAffectedSpells = new[] { conflagrateStr };
        private Talent conflagrate = new() { ID = "17962", Level = 1, Name = conflagrateStr, Effects = new Effect[] { new() { AffectedSpells = conflagrateAffectedSpells, Modify = Modify.LearnSpell, Value = 17962 } } };
        ...
        {
            new() { ID = "30288", Level = 1, Name = shadowAndFlameStr, Effects = new Effect[] { new() { AffectedSpells = shadowAndFlameAffectedSpells, Modify = Modify.SpellPowerPercent, Value = 4 } } },
            new() { ID = "30289", Level = 2, Name = shadowAndFlameStr, Effects = new Effect[] { new() { AffectedSpells = shadowAndFlameAffectedSpells, Modify = Modify.SpellPowerPercent, Value = 8 } } },
            new() { ID = "30290", Level = 3, Name = shadowAndFlameStr, Effects = new Effect[] { new() { AffectedSpells = shadowAndFlameAffectedSpells, Modify = Modify.SpellPowerPercent, Value = 12 } } },
            new() { ID = "30291", Level = 4, Name = shadowAndFlameStr, Effects = new Effect[] { new() { AffectedSpells = shadowAndFlameAffectedSpells, Modify = Modify.SpellPowerPercent, Value = 16 } } },
            new() { ID = "30292", Level = 5, Name = shadowAndFlameStr, Effects = new Effect[] { new() { AffectedSpells = shadowAndFlameAffectedSpells, Modify = Modify.SpellPowerPercent, Value = 20 } } }
        };

        private static string[] shadowfuryAffectedSpells = new[] { shadowfuryStr };
        private Talent shadowfury = new() { ID = "30283", Level = 1, Name = shadowfuryStr, Effects = new Effect[] { new() { AffectedSpells = shadowfuryAffectedSpells, Modify = Modify.LearnSpell, Value = 17962 } } };
        ...
        {
            new(){ ID = "18174", Level = 1, Name = suppressionStr, Effects = new Effect[] { new(){ AffectedSpells = suppressionAffectedSpells, Modify = Modify.SpellHitChance, Value = 2 } } },
            new(){ ID = "18175", Level = 2, Name = suppressionStr, Effects = new Effect[] { new(){ AffectedSpells = suppressionAffectedSpells, Modify = Modify.SpellHitChance, Value = 4 } } },
            new(){ ID = "18176", Level = 3, Name = suppressionStr, Effects = new Effect[] { new(){ AffectedSpells = suppressionAffectedSpells, Modify = Modify.SpellHitChance, Value = 6 } } },
            new(){ ID = "18177", Level = 4, Name = suppressionStr, Effects = new Effect[] { new(){ AffectedSpells = suppressionAffectedSpells, Modify = Modify.SpellHitChance, Value = 8 } } },
            new(){ ID = "18178", Level = 5, Name = suppressionStr, Effects = new Effect[] { new(){ AffectedSpells = suppressionAffectedSpells, Modify = Modify.SpellHitChance, Value = 10 } } }
        };
        ...
        {
            new(){ ID = "17810", Level = 1, Name = improvedCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCorruptionAffectedSpells, Modify = Modify.Casttime, Value = -400 } } },
            new(){ ID = "17811", Level = 2, Name = improvedCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCorruptionAffectedSpells, Modify = Modify.Casttime, Value = -800 } } },
            new(){ ID = "17812", Level = 3, Name = improvedCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCorruptionAffectedSpells, Modify = Modify.Casttime, Value = -1200 } } },
            new(){ ID = "17813", Level = 4, Name = improvedCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCorruptionAffectedSpells, Modify = Modify.Casttime, Value = -1600 } } },
            new(){ ID = "17814", Level = 5, Name = improvedCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCorruptionAffectedSpells, Modify = Modify.Casttime, Value = -2000 } } }
        };
        ...
        {
            new(){ ID = "18182", Level = 1, Name = improvedLifeTapStr, Effects = new Effect[] { new(){ AffectedSpells = improvedLifeTapAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 10 } } },
            new(){ ID = "18183", Level = 2, Name = improvedLifeTapStr, Effects = new Effect[] { new(){ AffectedSpells = improvedLifeTapAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 20 } } }
        };
        ...
        {
            new(){ ID = "18182", Level = 1, Name = soulSiphonStr, Effects = new Effect[] { new(){ AffectedSpells = soulSiphonAffectedSpells, Modify = Modify.Unique, Value = 2 } } },
            new(){ ID = "18183", Level = 2, Name = soulSiphonStr, Effects = new Effect[] { new(){ AffectedSpells = soulSiphonAffectedSpells, Modify = Modify.Unique, Value = 4 } } }
        };
        ...
        {
            new(){ ID = "18827", Level = 1, Name = improvedCurseOfAgonyStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCurseOfAgonyAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 5 } } },
            new(){ ID = "18829", Level = 2, Name = improvedCurseOfAgonyStr, Effects = new Effect[] { new(){ AffectedSpells = improvedCurseOfAgonyAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 10 } } }
        };

        private static string[] amplifyCurseAffectedSpells = new[] { amplifyCurseStr };
        private Talent amplifyCurse = new() { ID = "18827", Level = 1, Name = amplifyCurseStr, Effects = new Effect[] { new() { AffectedSpells = amplifyCurseAffectedSpells, Modify = Modify.LearnSpell, Value = 18288 } } };
        ...
        {
            new(){ ID = "18094", Level = 1, Name = nightfallStr, Effects = new Effect[] { new(){ AffectedSpells = nightfallAffectedSpells, Modify = Modify.PeriodicProc, Value = 2 } } },
            new(){ ID = "18095", Level = 2, Name = nightfallStr, Effects = new Effect[] { new(){ AffectedSpells = nightfallAffectedSpells, Modify = Modify.PeriodicProc, Value = 4 } } }
        };
        ...
        {
            new(){ ID = "32381", Level = 1, Name = empoweredCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = empoweredCorruptionSpells, Modify = Modify.SpellPowerPercent, Value = 12 } } },
            new(){ ID = "32382", Level = 2, Name = empoweredCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = empoweredCorruptionSpells, Modify = Modify.SpellPowerPercent, Value = 24 } } },
            new(){ ID = "32383", Level = 3, Name = empoweredCorruptionStr, Effects = new Effect[] { new(){ AffectedSpells = empoweredCorruptionSpells, Modify = Modify.SpellPowerPercent, Value = 36 } } }
        };

        private static string[] siphonLifeAffectedSpells = new[] { "Siphon Life" };
        private static string siphonLifeStr = "Siphon Life";
        private Talent siphonLife = new() { ID = "18827", Level = 1, Name = siphonLifeStr, Effects = new Effect[] { new() { AffectedSpells = siphonLifeAffectedSpells, Modify = Modify.LearnSpell, Value = 18265 } } };
        ...
        {
            new(){ ID = "18271", Level = 1, Name = shadowMasteryStr, Effects = new Effect[] { new(){ AffectedSpells = shadowMasteryAffectedSpellsPeriodic, Modify = Modify.PeriodicDamagePercent, Value = 2 }, new(){ AffectedSpells = shadowMasteryAffectedSpellsDamage, Modify = Modify.DamagePercent, Value = 2 } } },
            new(){ ID = "18272", Level = 2, Name = shadowMasteryStr, Effects = new Effect[] { new(){ AffectedSpells = shadowMasteryAffectedSpellsPeriodic, Modify = Modify.PeriodicDamagePercent, Value = 4 }, new(){ AffectedSpells = shadowMasteryAffectedSpellsDamage, Modify = Modify.DamagePercent, Value = 4 } } },
            new(){ ID = "18273", Level = 3, Name = shadowMasteryStr, Effects = new Effect[] { new(){ AffectedSpells = shadowMasteryAffectedSpellsPeriodic, Modify = Modify.PeriodicDamagePercent, Value = 6 }, new(){ AffectedSpells = shadowMasteryAffectedSpellsDamage, Modify = Modify.DamagePercent, Value = 6 } } },
            new(){ ID = "18274", Level = 4, Name = shadowMasteryStr, Effects = new Effect[] { new(){ AffectedSpells = shadowMasteryAffectedSpellsPeriodic, Modify = Modify.PeriodicDamagePercent, Value = 8 }, new(){ AffectedSpells = shadowMasteryAffectedSpellsDamage, Modify = Modify.DamagePercent, Value = 8 } } },
            new(){ ID = "18275", Level = 5, Name = shadowMasteryStr, Effects = new Effect[] { new(){ AffectedSpells = shadowMasteryAffectedSpellsPeriodic, Modify = Modify.PeriodicDamagePercent, Value = 10 }, new(){ AffectedSpells = shadowMasteryAffectedSpellsDamage, Modify = Modify.DamagePercent, Value = 10 } } }
        };
        ...
        {
            new(){ ID = "30060", Level = 1, Name = contagionStr, Effects = new Effect[] { new(){ AffectedSpells = contagionAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 1 } } },
            new(){ ID = "30061", Level = 2, Name = contagionStr, Effects = new Effect[] { new(){ AffectedSpells = contagionAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 2 } } },
            new(){ ID = "30062", Level = 3, Name = contagionStr, Effects = new Effect[] { new(){ AffectedSpells = contagionAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 3 } } },
            new(){ ID = "30063", Level = 4, Name = contagionStr, Effects = new Effect[] { new(){ AffectedSpells = contagionAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 4 } } },
            new(){ ID = "30064", Level = 5, Name = contagionStr, Effects = new Effect[] { new(){ AffectedSpells = contagionAffectedSpells, Modify = Modify.PeriodicDamagePercent, Value = 5 } } }
        };

        private static string[] unstableAfflictionAffectedSpells = new[] { unstableAfflictionStr };
        private Talent unstableAffliction = new() { ID = "30108", Level = 1, Name = unstableAfflictionStr, Effects = new Effect[] { new() { AffectedSpells = unstableAfflictionAffectedSpells, Modify = Modify.LearnSpell, Value = 30108 } } };
        ...
        {
            new(){ ID = "18694", Level = 1, Name = improvedImpStr, Effects = new Effect[] { new(){ AffectedSpells = improvedImpAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 10 } } },
            new(){ ID = "18695", Level = 2, Name = improvedImpStr, Effects = new Effect[] { new(){ AffectedSpells = improvedImpAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 20 } } },
            new(){ ID = "18696", Level = 3, Name = improvedImpStr, Effects = new Effect[] { new(){ AffectedSpells = improvedImpAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 30 } } }
        };
        ...
        {
            new(){ ID = "18731", Level = 1, Name = felIntellectStr, Effects = new Effect[] { new(){ AffectedSpells = felIntellectAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 5 }, new() { AffectedSpells = new[]{ "Mana" }, Modify = Modify.MaxMana, Value = 1} } },
            new(){ ID = "18743", Level = 2, Name = felIntellectStr, Effects = new Effect[] { new(){ AffectedSpells = felIntellectAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 10 }, new() { AffectedSpells = new[]{ "Mana" }, Modify = Modify.MaxMana, Value = 2} } },
            new(){ ID = "18744", Level = 3, Name = felIntellectStr, Effects = new Effect[] { new(){ AffectedSpells = felIntellectAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 15 }, new() { AffectedSpells = new[]{ "Mana" }, Modify = Modify.MaxMana, Value = 3} } }
        };
        ...
        {
            new(){ ID = "18754", Level = 1, Name = improvedSayaadStr, Effects = new Effect[] { new(){ AffectedSpells = improvedSayaadAffectedSpellsEffectiveness, Modify = Modify.SpellEffectiveness, Value = 10 }, new() { AffectedSpells = improvedSayaadAffectedSpellsBuffDuration, Modify = Modify.AuraDuration, Value = 10} } },
            new(){ ID = "18755", Level = 2, Name = improvedSayaadStr, Effects = new Effect[] { new(){ AffectedSpells = improvedSayaadAffectedSpellsEffectiveness, Modify = Modify.SpellEffectiveness, Value = 20 }, new() { AffectedSpells = improvedSayaadAffectedSpellsBuffDuration, Modify = Modify.AuraDuration, Value = 20} } },
            new(){ ID = "18756", Level = 3, Name = improvedSayaadStr, Effects = new Effect[] { new(){ AffectedSpells = improvedSayaadAffectedSpellsEffectiveness, Modify = Modify.SpellEffectiveness, Value = 30 }, new() { AffectedSpells = improvedSayaadAffectedSpellsBuffDuration, Modify = Modify.AuraDuration, Value = 30} } }
        };
        ...
        {
            new(){ ID = "30143", Level = 1, Name = demonicAegisStr, Effects = new Effect[] { new(){ AffectedSpells = demonicAegisAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 10 } } },
            new(){ ID = "30144", Level = 2, Name = demonicAegisStr, Effects = new Effect[] { new(){ AffectedSpells = demonicAegisAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 20 } } },
            new(){ ID = "30145", Level = 3, Name = demonicAegisStr, Effects = new Effect[] { new(){ AffectedSpells = demonicAegisAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 30 } } }
        };
        ...
        {
            new(){ ID = "18769", Level = 1, Name = unholyPowerStr, Effects = new Effect[] { new(){ AffectedSpells = unholyPowerAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 4 } } },
            new(){ ID = "18770", Level = 2, Name = unholyPowerStr, Effects = new Effect[] { new(){ AffectedSpells = unholyPowerAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 8 } } },
            new(){ ID = "18771", Level = 3, Name = unholyPowerStr, Effects = new Effect[] { new(){ AffectedSpells = unholyPowerAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 12 } } },
            new(){ ID = "18772", Level = 4, Name = unholyPowerStr, Effects = new Effect[] { new(){ AffectedSpells = unholyPowerAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 16 } } },
            new(){ ID = "18773", Level = 5, Name = unholyPowerStr, Effects = new Effect[] { new(){ AffectedSpells = unholyPowerAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 20 } } }
        };

        private static string[] demonicSacrificeAffectedSpells = new[] { demonicSacrificeStr };
        private Talent demonicSacrifice = new() { ID = "18788", Level = 1, Name = demonicSacrificeStr, Effects = new Effect[] { new() { AffectedSpells = demonicSacrificeAffectedSpells, Modify = Modify.LearnSpell, Value = 18788 } } };

        private static string[] soulLinkAffectedSpells = new[] { soulLinkStr };
        private Talent soulLink = new() { ID = "19028", Level = 1, Name = soulLinkStr, Effects = new Effect[] { new() { AffectedSpells = soulLinkAffectedSpells, Modify = Modify.LearnSpell, Value = 19028 } } };

        private static string[] felguardSpells = new[] { felguardStr };
        private Talent felguard = new() { ID = "30146", Level = 1, Name = felguardStr, Effects = new Effect[] { new() { AffectedSpells = felguardSpells, Modify = Modify.LearnSpell, Value = 30146 } } };
        ...
        {
            new(){ ID = "18767", Level = 1, Name = masterConjurorStr, Effects = new Effect[] { new(){ AffectedSpells = masterConjurorAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 15 } } },
            new(){ ID = "18768", Level = 2, Name = masterConjurorStr, Effects = new Effect[] { new(){ AffectedSpells = masterConjurorAffectedSpells, Modify = Modify.SpellEffectiveness, Value = 30 } } },
        };
        ...
        {
            new(){ ID = "23785", Level = 1, Name = masterDemonologistStr, Effects = new Effect[] { new(){ AffectedSpells = masterDemonologistAffectedSpells, Modify = Modify.Unique, Value = 1 } } },
            new(){ ID = "23822", Level = 2, Name = masterDemonologistStr, Effects = new Effect[] { new(){ AffectedSpells = masterDemonologistAffectedSpells, Modify = Modify.Unique, Value = 2 } } },
            new(){ ID = "23823", Level = 3, Name = masterDemonologistStr, Effects = new Effect[] { new(){ AffectedSpells = masterDemonologistAffectedSpells, Modify = Modify.Unique, Value = 3 } } },
            new(){ ID = "23824", Level = 4, Name = masterDemonologistStr, Effects = new Effect[] { new(){ AffectedSpells = masterDemonologistAffectedSpells, Modify = Modify.Unique, Value = 4 } } },
            new(){ ID = "23825", Level = 5, Name = masterDemonologistStr, Effects = new Effect[] { new(){ AffectedSpells = masterDemonologistAffectedSpells, Modify = Modify.Unique, Value = 5 } } }
        };
        ...
        {
            new(){ ID = "35691", Level = 1, Name = demonicKnowledgeStr, Effects = new Effect[] { new(){ AffectedSpells = demonKnowledgeAffectedSpells, Modify = Modify.Unique, Value = 4 } } },
            new(){ ID = "35692", Level = 2, Name = demonicKnowledgeStr, Effects = new Effect[] { new(){ AffectedSpells = demonKnowledgeAffectedSpells, Modify = Modify.Unique, Value = 8 } } },
            new(){ ID = "35693", Level = 3, Name = demonicKnowledgeStr, Effects = new Effect[] { new(){ AffectedSpells = demonKnowledgeAffectedSpells, Modify = Modify.Unique, Value = 12 } } }
        ...
        {
            new(){ ID = "30242", Level = 1, Name = demonicTacticsStr, Effects = new Effect[] { new(){ AffectedSpells = demonicTaticsAffectedSpellsPets, Modify = Modify.SpellEffectiveness, Value = 1 }, new(){ AffectedSpells = demonicTaticsAffectedSpellsPlayer, Modify = Modify.SpellCritChance, Value = 1 } } },
            new(){ ID = "30245", Level = 2, Name = demonicTacticsStr, Effects = new Effect[] { new(){ AffectedSpells = demonicTaticsAffectedSpellsPets, Modify = Modify.SpellEffectiveness, Value = 2 }, new(){ AffectedSpells = demonicTaticsAffectedSpellsPlayer, Modify = Modify.SpellCritChance, Value = 2 } } },
            new(){ ID = "30246", Level = 3, Name = demonicTacticsStr, Effects = new Effect[]{ new(){ AffectedSpells = demonicTaticsAffectedSpellsPets, Modify = Modify.SpellEffectiveness, Value = 3 }, new(){ AffectedSpells = demonicTaticsAffectedSpellsPlayer, Modify = Modify.SpellCritChance, Value = 3 } } },
            new(){ ID = "30247", Level = 4, Name = demonicTacticsStr, Effects = new Effect[] { new(){ AffectedSpells = demonicTaticsAffectedSpellsPets, Modify = Modify.SpellEffectiveness, Value = 4 }, new(){ AffectedSpells = demonicTaticsAffectedSpellsPlayer, Modify = Modify.SpellCritChance, Value = 4 } } },
            new(){ ID = "30248", Level = 5, Name = demonicTacticsStr, Effects = new Effect[] { new(){ AffectedSpells = demonicTaticsAffectedSpellsPets, Modify = Modify.SpellEffectiveness, Value = 5 }, new(){ AffectedSpells = demonicTaticsAffectedSpellsPlayer, Modify = Modify.SpellCritChance, Value = 5 } } }
        };
        ...
        private double CastLifeTap(Spell lifetap, Report report = null, double fightTick = 0)
        {
            ...
            int manaFromLT = ManaGainedFromLifetap(lifetap) + ((int)(SpellPower * 0.8));
            int ManaGained = 0;
            ...
            return lifetap.GCD / 1 + (SpellHaste / 100);
        }
        ...
        private double CastShadowBolt(Spell shadowbolt, Unit target, Report report = null, double fightTick = 0)
        {
            ...
            double dmg = 0;
            double gcd = shadowbolt.GCD;
            double castTime = shadowbolt.CastTime;
            Random rnd = new();
            ...
            castTime += casttimeMod;

            castTime /= 1 + (SpellHaste / 100);
            gcd /= 1 + (SpellHaste / 100);

            bool isCrit = rnd.Next(100) <= SpellCrit + critMod;
            lastSpelledCasted = shadowbolt;
            dmg = rnd.Next(GetShadowboltMinDmg(shadowbolt), GetShadowboltMaxDmg(shadowbolt) + 1);
            dmg = dmg + (ShadowPower * GetShadowboltSPMod(shadowbolt));
            ...
            report.ReportDamage(dmg, lastSpelledCasted, fightTick + Math.Max(castTime, gcd), dmg > 0, isCrit);
            return Math.Max(castTime, gcd);
        }
        ...
        public override double CastSpell(Spell spell, Unit target, double fightTick, Report report)
        {
            ...
            if (timeForward > 150000)
            {
                Console.WriteLine(timeForward);
            }
            return timeForward;
        }
